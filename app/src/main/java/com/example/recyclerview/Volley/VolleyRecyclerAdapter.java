...
public class VolleyRecyclerAdapter extends RecyclerView.Adapter<VolleyRecyclerAdapter.MyViewHolder> {
    ...
    public VolleyRecyclerAdapter(ArrayList<VolleyRecyclerData> arrayList) {
    ...
    public VolleyRecyclerAdapter(String[] myDataset) {
        mDataset = myDataset;
    }
    ...
    public VolleyRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        LinearLayout v = (LinearLayout) LayoutInflater.from(parent.getContext())
                .inflate(R.layout.volley_recycler_rows, parent, false);

        VolleyRecyclerAdapter.MyViewHolder vh = new VolleyRecyclerAdapter.MyViewHolder(v);
        return vh;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(VolleyRecyclerAdapter.MyViewHolder holder, int position) {
